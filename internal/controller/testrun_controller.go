...
// +kubebuilder:rbac:groups=bubo.test.rwdf.no,resources=testruns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bubo.test.rwdf.no,resources=testruns/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=bubo.test.rwdf.no,resources=testruns/finalizers,verbs=update
